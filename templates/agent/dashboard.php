                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6"><?= $Core->Monify($Core->SumAgentTransactions($UserInfo->accid)) ?></div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6"><?= $Core->Monify($Core->SumAgentUnpaidTransactions($UserInfo->accid)) ?></div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6"><?= $Core->Numberfy($Core->CountAgentTransactions($UserInfo->accid)) ?></div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6"><?= $Core->Numberfy($Core->CountAgentClients($UserInfo->accid)) ?></div>
